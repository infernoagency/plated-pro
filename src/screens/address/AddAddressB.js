...
export default class AddAddressB extends Component {
  ...
  render() {
    const { addressType, numberFocused, streetFocused, address1Focused, address2Focused, stateFocused, districtFocused, zipFocused, cityFocused, modalVisible } = this.state;
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputContainer}>
              <UnderlineTextInput
                ...
                onChangeText={this.onChangeText("address1")}
                onFocus={this.onFocus("address1Focused")}
                inputFocused={address1Focused}
           ...
           <View style={styles.inputContainer}>
              <UnderlineTextInput
                ...
                onChangeText={this.onChangeText("address2")}
                onFocus={this.onFocus("address2Focused")}
            ...
            <View style={styles.row}>
              ...
              <View style={[styles.inputContainer, styles.large]}>
                <UnderlineTextInput
                  ...
                  onSubmitEditing={this.focusOn(this.state)}
                  returnKeyType="done"
                  blurOnSubmit={false}
                  placeholder="City"
                  placeholderTextColor={PLACEHOLDER_TEXT_COLOR}
              ...
              <UnderlineTextInput
                ...
                onFocus={this.onFocus("stateFocused")}
                inputFocused={stateFocused}
                onSubmitEditing={this.focusOn(this.saveAddress)}
                returnKeyType="next"
                blurOnSubmit={false}
                placeholder="State"
                placeholderTextColor={PLACEHOLDER_TEXT_COLOR}
