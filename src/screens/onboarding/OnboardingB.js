...
const slide1Img = require("../../assets/img/cooking.png");
const slide2Img = require("../../assets/img/bartender.png");
const slide3Img = require("../../assets/img/baker.png");

const slides = [
  {
    id: "slide1",
    img: slide1Img,
    title: "Book A Personal Chef",
    description:
      "Easy and fast way to find personal chefs that can cook for you or to cater your events and parties."
  },
  {
    id: "slide2",
    img: slide2Img,
    title: "Find Local Bartenders",
    description: "Book the best bartenders in town for your next event or party."
  },
  {
    id: "slide3",
    img: slide3Img,
    title: "Cure Your Sweet Tooth",
    description: "Ready for custom desserts from your city's best bakers?"
  }
];
