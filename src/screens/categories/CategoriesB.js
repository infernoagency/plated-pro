  ...
  constructor(props) {
    ...
    this.state = {
      categories: [
        {
          key: 1,
          imageUri: require("../../assets/img/italian.jpg"),
          name: "Italian",
          items: 5
        },
        {
          key: 2,
          imageUri: require("../../assets/img/healthy.jpg"),
          name: "Healthy",
          items: 5
        },
        {
          key: 3,
          imageUri: require("../../assets/img/soul-food.jpg"),
          name: "Soul Food",
          items: 5
        },
        {
          key: 4,
          imageUri: require("../../assets/img/mexican.jpg"),
          name: "Mexican",
          items: 5
        },
        {
          key: 5,
          imageUri: require("../../assets/img/vegan.jpg"),
          name: "Vegan",
          items: 5
        },
        {
          key: 6,
          imageUri: require("../../assets/img/desserts.jpg"),
          name: "Dessert",
          items: 8
        }
      ]
      ...
      <View style={styles.cardOverlay}>
        ...
        >
          <Fragment>
            ...
            <Text style={styles.items}>{`${item.items} Chefs`}</Text>
          </Fragment>
        </TouchableItem>
      </View>
    </ImageBackground>
